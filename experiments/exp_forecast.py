...
class Exp_Forecast(Exp_Basic):
     ...
     def save_linear_weight_2npy(self, setting=None):
          ...
          if not os.path.exists(self.args.save_linear_weight_path):
               os.makedirs(self.args.save_linear_weight_path, exist_ok=True)
     ...
     def train(self, setting=None):
                    ...
                    if self.args.use_amp:
                         ...
                         if (i + 1) % 100 == 0 or i == 0:
                              ...
                              if self.args.grad_clip:
                                   ...
                                   print(f"\t\tTotal norm of gradients: {grd_norm:.2f}")
                         if self.args.grad_clip:
                              clip_grad_nrom_(self.model.parameters(), self.args.max_norm)
          ...
          best_model_path = os.path.join(path, 'check_point.pth')
          ...
          with torch.no_grad():
               for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(test_loader):
                    ...
                    if test_data.scale and self.args.inverse:
                         ...
                         dec_seq_inter = [test_data.inverse_transform(seq.squeeze(0)).reshape(shape) for seq in dec_seq_inter]
                    ...
                    if i % save_period == 0:
                         ...
                         if self.args.save_pdf:
                              ...
                              visual(gt, pd, os.path.join(save_folder,
                                                    ...
                                                    if self.imp_mode else f'{self.args.model_id}_batch_{i}_pred-gt.pdf'), imp=self.imp_mode)
