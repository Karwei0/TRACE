...
from experiments.exp_vali import Exp_Validation
import random
import numpy as np
...
if __name__ == '__main__':
    ...
    parser.add_argument('--task_name', type=str, default='forecasting',
                        help='task_name', choices=['forecasting', 'long_term_forecast',
                                                   'imputation', 'short_term_forecast', 'exp_vali'])
    ...
    # chaos learning demo parameters
    parser.add_argument('--d_chaos', type=int, default=3, help='dimension of chaos oscillator/system')
    parser.add_argument('--t_evo', type=float, default=0.5, help='time step for chaos system')
    parser.add_argument('--num_step', type=int, default=20, help='number of time steps')
    parser.add_argument('--chaos_para_nn', type=int, default=0, help='whether to use neural network to learn chaos parameters')
    parser.add_argument('--decay_rate', type=float, default=1.0, help='default decay rate for chaos parameters')
    parser.add_argument('--coupling_strength', type=float, default=0.1, help='coupling strength')
    parser.add_argument('--invert', type=int, default=0, help='whether to invert the input data')
    parser.add_argument('--chaos_type', type=str, default='lorenz', help='chaos type')
    parser.add_argument('--derivation', type=str, default='euler', help='derivation method')
    parser.add_argument('--dec_layers', type=int, default=1, help='dec_layers')
    parser.add_argument('--enc_layers', type=int, default=2, help='enc_layers')

    # tarce damped
    parser.add_argument('--gamma', type=float, default=3.0)
    parser.add_argument('--omega_sq', type=float, default=1.0)
    
    # coupling strategy
    parser.add_argument('--coupling_strategy', type=str, default='temporal', choices=['temporal', 'all'])
    parser.add_argument('--coupling_decay_type', type=str, default='linear', choices=['linear', 'exponent'])
    ...
    elif args.task_name == 'partial_train':  # See Figure 8 of our paper, for the detail
        Exp = Exp_Long_Term_Forecast_Partial
    elif args.task_name == 'imputation':
        Exp = Exp_Imputation
    elif args.task_name == 'exp_vali':
        # print('hhh')
        Exp = Exp_Validation
